...
class SetVelocityYawRateRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVelocityYawRateRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVelocityYawRateRequest
    let len;
    let data = new SetVelocityYawRateRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVelocityYawRateRequest(null);
    if (msg.vx !== undefined) {
      resolved.vx = msg.vx;
    }
    else {
...
class SetVelocityYawRateResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVelocityYawRateResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVelocityYawRateResponse
    let len;
    let data = new SetVelocityYawRateResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'marker_navigator/SetVelocityYawRateResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVelocityYawRateResponse(null);
...
module.exports = {
  Request: SetVelocityYawRateRequest,
  Response: SetVelocityYawRateResponse,
  md5sum() { return 'd3735930254b75ba322bcc1e0750d89d'; },
  datatype() { return 'marker_navigator/SetVelocityYawRate'; }
};
